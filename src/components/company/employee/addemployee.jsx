            ...
            <div className="col-md-6">
              ...
              <div className="col-md-4">
                  ...
                  <div className="form-group col">
                      ...
                      <input placeholder="Contact Number" name="Contact_Number" type="text" className="form-control" onChange={handleChange}
                        value={contact} />
                    </div>
                    <div className="form-group col">
                      <label>Emergency Contact Number</label>
                      <input placeholder="Emergency Contact Number" name="Emergency_Contact_Number" type="text" className="form-control" onChange={handleChange}
                        value={Number2} />
                    </div>
                    <div className="form-group col">
                      <label> Email</label>
                      <input placeholder=" Email" required name="Personal_Email" type="email" className="form-control" onChange={handleChange}
                        value={Email} />
                    </div>
